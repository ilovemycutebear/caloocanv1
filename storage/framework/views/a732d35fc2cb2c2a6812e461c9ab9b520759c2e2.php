...
<div class="custom-container container">
    <div class="row">
      ...
      <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        ...
        <div class="col-xs-6 col-md-4 center-block" style=" padding-left: 300px;"><h2 class="bg-textc">   <?php echo e($latestcrsl[1]->water); ?> M</h2></div>
        <div class="col-xs-6 col-md-4 center-block" style=" padding-left: 500px;"><h2 class="bg-textc">   <?php echo e($latestcrsl[2]->rainten); ?> mm</h2></div>



          <?php if($latestcrsl[0]->sensor == 2 ): ?>
            <?php if($latestcrsl[0]->siteid == 01 ): ?>
        ...
        <?php if(strtotime($latestcrsl[0]->asof) > strtotime(\Carbon\Carbon::now()->subMinutes(20)->format('F d Y h:i:s A'))): ?>
          ...
          <?php endif; ?>
        <?php endif; ?> <!--if siteid is 01-->



            <?php if($latestcrsl[1]->sensor == 2 ): ?>

              <?php if($latestcrsl[1]->siteid == 02 ): ?>
          

          <!--div class="col-xs-6 col-md-4 center-block" style=" padding-left: 500px;"><h2 class="bg-textc">
          <?php echo e($siteinfos->asof); ?></br>
          <?php echo e(\Carbon\Carbon::now()->subMinutes(20)->format('F d Y h:i:s A')); ?>
